...
const MedecinRegisterForm = () => {
  ...
  const handleRegister = (e) => {
    ...
    const etape1 = { nom, telephone, email, dateNaissance };
    localStorage.setItem("medecinEtape1", JSON.stringify(etape1));
          ...
          <form className="form-container" onSubmit={handleRegister}>
            <div className="champ-formulaire">
              ...
              <div className="input-icon">
                ...
                <input type="text" placeholder="Dr. Jean Dupont" id="NOM"
            ...
            <div className="champ-formulaire">
              ...
              <div className="input-icon">
                ...
                <input type="number" placeholder="+213..." id="nb"
            ...
            <div className="ligne-horizontale">
              <div className="champ-formulaire pass">
                ...
                <div className="input-icon">
                  ...
                  <input type="password" id="ps" placeholder="......"
              ...
              <div className="champ-formulaire Cpass">
                ...
                <div className="input-icon">
                  <i className="fa-solid fa-lock"></i>
                  <input type="password" id="Cps" placeholder="......"
            ...
            <div className="boite-securite">
              ...
              <p>Vos données sont chiffrées selon les normes HDS en vigueur.</p>
            </div>
