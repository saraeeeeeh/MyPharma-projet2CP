...
const MedecinLogingPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const medecinComplet = {
      ...
      adresse,
      diplome: fileName,
      membreDepuis: new Date().toLocaleDateString('fr-FR', {
        month: 'long', year: 'numeric'
      }),
    };

    localStorage.setItem("medecinConnecte", JSON.stringify(medecinComplet));
    
    // On met à jour medecinEtape1 avec le profil complet pour que ConnectMedecinPage.jsx puisse simuler correctement une vraie reconnexion
    localStorage.setItem("medecinEtape1", JSON.stringify(medecinComplet));

    navigate("/profil"); // → page profil
  };
